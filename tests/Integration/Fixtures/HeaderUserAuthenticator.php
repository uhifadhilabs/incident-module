 ...
 *
 * The host owns the host's firewall and mints the tokens; this bundle's
 * tests are about what its OWN endpoints do once someone is authenticated —
 * whether they demand `incidents.record`, and whether they are idempotent. So the
 ...
 *
 * Stateless matters and is not incidental. the host declares its operations
