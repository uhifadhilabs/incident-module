...
namespace Uhifadhi\Incident\Tests\Fixtures\Account;
 ...
 * published contract yet, and the department slice this module reports by walks
 * it in DQL (`IncidentRepository::departmentScoped()`), never through a type. So
 * this class provides one for that join to walk.
 */
#[ORM\Entity]
...
class User implements SecurityUserInterface, UserInterface
{
    ...
    /**
     * The short service number a field worker knows themselves by. Nothing here
     * reads it; it is on the class because the contract asks every account for
     * one, and a class that answered six of seven questions would not be an
     * answer to the contract at all.
     */
