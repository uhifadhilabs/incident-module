 ...
 *
 * The shell's `.factband` carries `margin: 0 0 20px`, so the space between the
 * identity band the case file wears and whatever the screen puts under it is
 * already spent. An element that then states its own top margin spends it
 * twice, and the band floats away from the page it belongs to by an amount that
 * depends on which screen you are on.
 *
 ...
 * place.
 *
 * The shape is the core's own IdentityBandSpacingTest in AreaBundle, applied to
