 ...
 * document — and every generated preview of one — was (correctly, by the seam's
 ...
 * chain the lookup below already reaches; the seam does not change, only the
...
final class IncidentEvidenceVoter implements EvidenceAccessVoterInterface
{
    ...
    public function mayRead(string $key, ?UserInterface $user): bool
    {
        ...
        // stopped them before this, but the seam is asked anyway and must answer
