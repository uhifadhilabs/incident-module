 ...
 *
 * @extends ServiceEntityRepository<IncidentSettings>
 */
final class IncidentSettingsRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, IncidentSettings::class);
    }

    public function findOneByArea(AreaOfInterest $area): ?IncidentSettings
    {
