 ...
 *
 * @extends ServiceEntityRepository<IncidentMoney>
 */
final class IncidentMoneyRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, IncidentMoney::class);
    }
}
